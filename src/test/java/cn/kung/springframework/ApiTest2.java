...
import cn.kung.springframework.aop.*;
import cn.kung.springframework.aop.aspectj.AspectJExpressionPointcut;
import cn.kung.springframework.aop.aspectj.AspectJExpressionPointcutAdvisor;
import cn.kung.springframework.aop.framework.ProxyFactory;
import cn.kung.springframework.aop.framework.ReflectiveMethodInvocation;
import cn.kung.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
public class ApiTest2 {
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* cn.kung.springframework.aop.IUserService.*(..))");
    ...
    public void test_proxy_method() {
        ...
        IUserService proxy = (IUserService) Proxy.newProxyInstance(Thread.currentThread().getContextClassLoader(), targetObj.getClass().getInterfaces(), new InvocationHandler() {
            // 方法匹配器
            MethodMatcher methodMatcher = new AspectJExpressionPointcut("execution(* cn.kung.springframework.aop.IUserService.*(..))");
